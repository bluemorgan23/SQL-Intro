...
INSERT INTO Artist (ArtistName, YearEstablished) VALUES ('Widespread Panic', 1986);
SELECT * FROM Artist;

-- DELETE FROM Artist WHERE ArtistName = 'Jisie David';

-- 3. Using the INSERT statement, add one, or more, albums by your artist to the Album table.
INSERT INTO Album (Title, AlbumLength, ReleaseDate, Label, ArtistId) VALUES ('Space Wrangler', 86, 1988, 'Capricorn', 34);
INSERT INTO Album (Title, AlbumLength, ReleaseDate, Label, ArtistId) VALUES ('Til The Medicine Takes', 122, 1999, 'Capricorn', 34);

SELECT * FROM Album;

-- 4. Using the INSERT statement, add some songs that are on that album to the Song table

INSERT INTO Song (Title, SongLength, ReleaseDate, AlbumId, ArtistId) VALUES ('Space Wrangler', 180, '01/01/1988', 31, 34);
INSERT INTO Song (Title, SongLength, ReleaseDate, AlbumId, ArtistId) VALUES ('Blue Indian', 210, '01/01/1999', 32, 34);
